...
class CreativePager{
    ...
    function pager($params){
        ...
        $out='';
        if($this->info1)
            $out.='<span id="'.$this->id.'_info1"'.($this->class!='' ? ' class="'.$this->class.'_info1"' : '').'>'.'Total: '.$this->total_items.'</span>';
        ...
        if($this->info2)
            $out.='<span id="'.$this->id.'_info2"'.($this->class!='' ? ' class="'.$this->class.'_info2"' : '').'>'.'Page: '.$this->selected_page.' of '.$this->total_pages.'</span>';
