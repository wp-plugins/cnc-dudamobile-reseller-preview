...
class CreativeTable{
    ...
    function table($params){
        ...
        $this->search_html          = isset($params['search_html']) ? $params['search_html'] : '<span id="#ID#_search_value">Search...</span><a id="#ID#_advanced_search" href="javascript: ctShowAdvancedSearch(\'#ID#\');" title="Advanced Search"><img src="../wp-content/plugins/dudapro/images/advanced_search.png" /></a><div id="#ID#_loader"></div>';
